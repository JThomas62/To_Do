  ...
  const renderTodos = () => {
    ...
    todos.forEach((todo, index) => {
      ...
      li.innerHTML = `
        ...
        <div>
          <button class="${todo.completed ? 'uncomplete' : 'complete'}">${todo.completed ? 'Uncomplete' : 'Complete'}</button>
      ...
      li.querySelector('.complete, .uncomplete').addEventListener('click', (e) => {
